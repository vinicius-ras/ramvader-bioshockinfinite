...
namespace BioShredderInfinite
{
	...
	public enum ECheat
	{
		...
		evCheatOneHitKill,
		/// <summary>Identifies the "Songbird Hack" cheat.</summary>
		evCheatSongbirdHack,
	}
	...
	public enum ECodeCave
	{
		...
		/// <summary>Identifies the code cave used for the "Songbird Hack" cheat.</summary>
		[CodeCaveDefinition( 0xF3, 0x0F, 0x11, 0x86, 0x8C, 0x00, 0x00, 0x00, 0x50, 0x31, 0xC0, 0xB0, 0x14, 0x50, 0xDB, 0x04, 0x24, 0x58, 0x58, 0xD9,
			0x9E, 0x8C, 0x00, 0x00, 0x00, 0xC3 )]
		evCodeCaveSongBirdHack,
	}
